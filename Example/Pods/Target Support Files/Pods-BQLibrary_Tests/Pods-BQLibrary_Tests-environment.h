...
// BQLibrary
#define COCOAPODS_POD_AVAILABLE_BQLibrary
#define COCOAPODS_VERSION_MAJOR_BQLibrary 0
#define COCOAPODS_VERSION_MINOR_BQLibrary 1
#define COCOAPODS_VERSION_PATCH_BQLibrary 0
